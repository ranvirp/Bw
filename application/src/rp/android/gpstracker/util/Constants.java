...
public class Constants
{
   ...
   public static final String SERVICENAME = "rp.android.gpstracker.intent.action.GPSLoggerService";
   public static final String STREAMBROADCAST = "rp.android.gpstracker.intent.action.STREAMBROADCAST";
   ...
   public static final String LOGGING_STATE_CHANGED_ACTION = "rp.android.gpstracker.LOGGING_STATE_CHANGED";
    ...
    * 
    */
   public static final String EXTRA_LOGGING_PRECISION = "rp.android.gpstracker.EXTRA_LOGGING_PRECISION";
    ...
    * @see #STOPPED
    */
   public static final String EXTRA_LOGGING_STATE = "rp.android.gpstracker.EXTRA_LOGGING_STATE";
    ...
    */
   public static final String EXTRA_DISTANCE = "rp.android.gpstracker.EXTRA_DISTANCE";
   /**
    * A time period in minutes
    */
   public static final String EXTRA_TIME = "rp.android.gpstracker.EXTRA_TIME";
   /**
    * The location that pushed beyond the set minimum time or distance 
    */
   public static final String EXTRA_LOCATION = "rp.android.gpstracker.EXTRA_LOCATION";
   /**
    * The track that is being logged
    */
   public static final String EXTRA_TRACK =  "rp.android.gpstracker.EXTRA_TRACK";
