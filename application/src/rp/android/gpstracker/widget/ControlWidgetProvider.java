 ...
 *
 */
package rp.android.gpstracker.widget;
...
public class ControlWidgetProvider extends AppWidgetProvider
{
   ...
   static final ComponentName THIS_APPWIDGET = new ComponentName("rp.android.gpstracker", "rp.android.gpstracker.widget.ControlWidgetProvider");
