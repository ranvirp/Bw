 ...
 *------------------------------------------------------------------------------
 */
package rp.android.gpstracker.viewer.map;
...
import rp.android.gpstracker.actions.BwOptions;
import rp.android.gpstracker.actions.BwStart;
import rp.android.gpstracker.actions.ControlTracking;
import rp.android.gpstracker.actions.InsertNote;
import rp.android.gpstracker.actions.ShareTrack;
import rp.android.gpstracker.actions.Statistics;
...
import rp.android.gpstracker.util.SlidingIndicatorView;
import rp.android.gpstracker.util.UnitsI18n;
import rp.android.gpstracker.viewer.About;
import rp.android.gpstracker.viewer.ApplicationPreferenceActivity;
import rp.android.gpstracker.viewer.TrackList;
import rp.android.gpstracker.viewer.map.overlay.BitmapSegmentsOverlay;
import rp.android.gpstracker.viewer.map.overlay.SegmentRendering;
   ...
   protected void onActivityResult(int requestCode, int resultCode, Intent intent)
   {
      ...
      switch (requestCode)
      {
         ...
         case MENU_TRACKING:
             ...
             * updated by ranvir
             */
            if (resultCode==TRACK_STOP)
            {
               mLoggerMap.getActivity().setResult(Activity.RESULT_OK,intent);
