...
import rp.android.gpstracker.oauth.PrepareRequestTokenActivity;
...
public class BreadcrumbsService extends Service implements Observer, ProgressListener
{
   ...
   public static final String NOTIFY_DATA_SET_CHANGED = "rp.android.gpstracker.intent.action.NOTIFY_DATA_SET_CHANGED";
   public static final String NOTIFY_PROGRESS_CHANGED = "rp.android.gpstracker.intent.action.NOTIFY_PROGRESS_CHANGED";
